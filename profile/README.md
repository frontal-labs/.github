...
- **Issues**: Report bugs via [GitHub Issues](https://github.com/frontal-labs/frontal/issues);
- **Discussions**: Ask questions in [GitHub Discussions](https://github.com/frontal-labs/frontal/discussions);
